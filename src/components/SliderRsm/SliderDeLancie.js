...
import background from '../../images/de-lancie-background.jpg';
import martinetLarge from '../../images/john-de-lancie-big.png';
	...
	render() {
		...
		const translations = {
			no: {
				...
				title: 'Møt John De Lancie',
				titleSub: 'Q fra Star Trek, Discord fra My Little Pony',
			},
			en: {
				logo: logoEn,
				...
				title: 'Møt John De Lancie',
				titleSub: 'Q from Star Trek, Discord from My Little Pony',
			},
		};
		...
		return (
			<SliderRsmContainer innerWidth={innerWidth} innerHeight={innerHeight}>
				...
				<Backdrop />
				<FixedLeftLarge>
					<PersonImage src={martinetLarge} alt="John De Lancie" />
				</FixedLeftLarge>
				<SliderContainer>
					<SliderInfo>
